...
public interface IProductService
{
    ...
    Task<PagedResult<ProductCatalogSummaryDto>> GetCatalogProductsAsync(ProductQueryParameters query);
    Task<ProductCatalogDetailDto?> GetProductCatalogByIdAsync(int id);
